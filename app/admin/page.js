    ...
    <Page>
      ...
      <ol className="space-y-4">
        <li>
          ...
          connection string with the name of the database and a contain. It's
          better to not create the container yourself, as the app will create it
          with the correct partition key.
        </li>
        <li>
